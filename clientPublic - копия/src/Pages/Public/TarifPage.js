        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <div className="px-3">
              <Button
                type="empty"
                className="text-decode text-left bg-gray f-14"
              >
          ...
          >
            ...
            неделю. Далее необходимо продлить тариф. Историю и данные по
            текущему тарифу Вы можете посмотреть на странице Тарифы. У вас есть
            возможность купить тариф (на 1 неделю, месяц, 3 месяца, полгода и
...
export default connect(mapStateToProps)(TarifPage);
