            ...
            >
              {this.state.doContract && (
                <div className="pt-2">
                  ...
                  <div className="mt-2">
                    <CheckBox id="cargo52" text="Страхование груза водителем" />
                  </div>
                  <div className="mt-2">
            ...
            >
              {this.state.paymentMethods && (
                <div className="pt-2">
                  ...
                  <div className="mt-2">
                    <CheckBox id="cargo62" text="Страхование груза водителем" />
                  </div>
                  <div className="mt-2">
    ...
    return (
      <div className={`step-create ${this.props.className}`}>
        ...
        >
          ...
          >
            <Select type="text" placeholder="Ед. измерения" getRef={() => {}} />
          </div>
          <div
            className="col"
            style={{
