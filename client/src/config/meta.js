...
export default [
  {
    key: "main",
    title: (options) =>
      "Pogrooz - найти заказ и предложение на попутную грузоперевозку.",
    descriptions: (options) =>
      `Здесь более 100 предложений на перевозку груза в Вашем городе без посредников. Цены на грузоперевозку. Объявления от водителей и заказы на перевозку напрямую.`,
  },
  {
    key: "orderSearch",
    title: (options) =>
