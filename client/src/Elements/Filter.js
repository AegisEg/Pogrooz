        ...
        return (
            <div className="filter">
                <div className="row">
                    ...
                    <Link to="/" className={'col-md-4 col-lg-4 col-xl-3  col-sm-6'}><Button width={'100%'} type="fill" paddingVertical={'8px'} margin={'0 15px 0 0'}>Найти</Button></Link>
                </div>
                ...
                {this.state.show && <div className="row filter-line">
                    ...
                    <div className="row col-md-4 col-lg-4 col-xl-3  col-sm-6" style={{marginLeft: '0', marginRight: '0', alignItems: 'center'}}>
                ...
                {this.state.show && <div className="row filter-line" style={{marginBottom: 30}}>
